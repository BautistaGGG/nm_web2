    ...
    <div className="bg-white">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        ...
        <p className="text-xl tracking-tight text-gray-500">
          Otras personas como vos te cuentan su historia, y como fue el
          recorrido en su viaje hacia su nuevo yo.
        </p>
          ...
          >
            ...
            <blockquote>
              <p className="text-base italic font-medium text-gray-900 dark:text-white">
                ...
                conocimiento en técnicas y ejercicios era nulo, pero con Nicolás
                tuve rutinas arregladas para un mayor avance y eficaz
                crecimiento, noté un gran cambió que nunca creí ser capaz de
                alcanzar. Me abrió la cabeza en el sentido nutricional, ahora
                distingo lo bueno de lo no tan recomendable y como armar un buen
                plato, además de aprender a evitar lesiones."
              </p>
            </blockquote>
            <hr className="my-4" />
            <figcaption className="flex items-center justify-center mt-4 space-x-3 rtl:space-x-reverse">
        ...
        <h2 className="my-8 text-2xl tracking-tight font-extrabold text-gray-900">
          DESCUBRE COMO TRANSFORMAR TU CUERPO Y MENTE CON NUESTROS PLANES
          FITNESS
        </h2>

        <div
          className="grid grid-cols-1 xl:grid xl:grid-cols-2 gap-8 xl:gap-10 my-12"
          id="planes"
        >
          {/* <!-- Pricing Card --> */}
