      ...
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 pt-[115px] lg:pt-[160px]">
        ...
        <div className="mt-4 md:mt-0">
          ...
          <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
            Bajo nuestro acompañamiento vas a poder lograr una salud optima,
            junto con nuestro equipo de nutrición certificado logramos el combo
            perfecto para que alcances tus metas de una forma integral.
          </p>
          <a
            href="#"
            className="inline-flex items-center text-white bg-violeta hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900"
          >
            Comencemos
            <svg
