import logoNico2 from "../assets/logo_blanco_recortada.svg";
        ...
        <article className="gap-16 items-start py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <aside className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="text-left text-[1.65rem] lg:text-4xl m-0 lg:mb-4  tracking-tight font-extrabold text-white dark:text-white">
              ...
              <span className="inline text-[#82027D] ml-1"> + </span>
            </h2>
            ...
            <h2 className="mb-4 text-left italic text-2xl xl:text-4xl tracking-tight font-extrabold text-[#FF3399] lg:text-[#82027D] dark:text-white">
              {" "}
              TRANSFORMACIÓN{" "}
            </h2>
        ...
        <article className="items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-16">
            <Fade
              direction="left"
              triggerOnce
              className="w-full lg:w-3/4 lg:justify-self-end"
            >
              <img
            ...
            <Fade
              direction="right"
              triggerOnce
              className="w-full lg:w-3/4 lg:justify-self-start"
            >
              <img
                className="rounded-lg"
