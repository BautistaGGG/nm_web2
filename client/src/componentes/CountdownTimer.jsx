...
const CountdownTimer = ({ targetDate }) => {
  ...
  return (
    <div className={`${bgColor} fixed bottom-4 left-1/2 transform -translate-x-1/2  text-white p-4 rounded-md shadow-lg flex flex-col md:flex-col items-center justify-between transition-colors duration-500 ease-in-out z-50 w-11/12 max-w-72 ld:max-w-[60rem]`}>
