...
import trans8 from "../assets/transformaciones/8.png";
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="h-56 sm:h-64 xl:h-80 2xl:h-96">
            <Carousel slideInterval={3000} className="w-full ">
              <div className="flex h-full justify-center space-x-4 items-center overflow-x-auto          ">
                <img
                  src={trans1}
                  alt="Slide 1"
              ...
              <div className="flex h-full justify-center items-center overflow-x-auto  border-double        ">
                <img
                  src={trans2}
                  alt="Slide 2"
                  className="w-full lg:w-2/3 xl:w-1/3"
